package com.llmagent.data.image;
...
public final class Image {
    ...
    public String toString() {
        return "Image {" +
                " url = " + StringUtil.quoted(url) +
                ", base64Data = " + StringUtil.quoted(base64Data) +
                ", mimeType = " + StringUtil.quoted(mimeType) +
                ", revisedPrompt = " + StringUtil.quoted(revisedPrompt) +
                " }";
    }

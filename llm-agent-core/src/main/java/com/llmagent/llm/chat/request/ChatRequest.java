 ...
 * This class encapsulates the messages and parameters required for the chat interaction.
 *
 * <p>
 * In all language models that implement {@link ChatLanguageModel} or {@link StreamingChatLanguageModel},
 * must override the #doChat function, and this class is recommended to be used for interacting with the language model.
 * </p>
 */

...
import com.llmagent.vector.store.condition.*;
...
public class SearchWrapper extends VectorData {
    ...
    public SearchWrapper eq(Connector connector, String key, Object value) {
        if (this.condition == null) {
            this.condition = new Condition(Operator.EQ, new Key(key), new Value(value));
        } else {
            this.condition.connect(new Condition(Operator.EQ, new Key(key), new Value(value)), connector);
        }
        return this;
    }
    ...
    public SearchWrapper ne(Connector connector, String key, Object value) {
        if (this.condition == null) {
            this.condition = new Condition(Operator.NE, new Key(key), new Value(value));
        } else {
            this.condition.connect(new Condition(Operator.NE, new Key(key), new Value(value)), connector);
        }
        return this;
    }
    ...
    public SearchWrapper gt(Connector connector, String key, Object value) {
        if (this.condition == null) {
            this.condition = new Condition(Operator.GT, new Key(key), new Value(value));
        } else {
            this.condition.connect(new Condition(Operator.GT, new Key(key), new Value(value)), connector);
        }
        return this;
    }
    ...
    public SearchWrapper ge(Connector connector, String key, Object value) {
        if (this.condition == null) {
            this.condition = new Condition(Operator.GE, new Key(key), new Value(value));
        } else {
            this.condition.connect(new Condition(Operator.GE, new Key(key), new Value(value)), connector);
        }
        return this;
    }
    ...
    public SearchWrapper lt(Connector connector, String key, Object value) {
        if (this.condition == null) {
            this.condition = new Condition(Operator.LT, new Key(key), new Value(value));
        } else {
            this.condition.connect(new Condition(Operator.LT, new Key(key), new Value(value)), connector);
        }
        return this;
    }
    ...
    public SearchWrapper le(Connector connector, String key, Object value) {
        if (this.condition == null) {
            this.condition = new Condition(Operator.LE, new Key(key), new Value(value));
        } else {
            this.condition.connect(new Condition(Operator.LE, new Key(key), new Value(value)), connector);
        }
        return this;
    }
    ...
    public SearchWrapper in(Connector connector, String key, Collection<?> values) {
        if (this.condition == null) {
            this.condition = new Condition(Operator.IN, new Key(key), new Value(values.toArray()));
        } else {
            this.condition.connect(new Condition(Operator.IN, new Key(key), new Value(values.toArray())), connector);
        }
        return this;
    }
    ...
    public SearchWrapper min(Connector connector, String key, Object value) {
        if (this.condition == null) {
            this.condition = new Condition(Operator.NIN, new Key(key), new Value(value));
        } else {
            this.condition.connect(new Condition(Operator.NIN, new Key(key), new Value(value)), connector);
        }
        return this;
    }
    ...
    public SearchWrapper between(Connector connector, String key, Object start, Object end) {
        if (this.condition == null) {
            this.condition = new Condition(Operator.BETWEEN, new Key(key), new Value(start, end));
        } else {
            this.condition.connect(new Condition(Operator.BETWEEN, new Key(key), new Value(start, end)), connector);
        }
        return this;
    }

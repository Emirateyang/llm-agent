...
public class MetadataFilterBuilder {
    ...
    public Filter ginCompareExpression(String value) {
        return new GINOperator(key, value);
    }

    public Filter sqlCompareExpression(String value) {
        return new SqlExpression(key, value);
    }
}

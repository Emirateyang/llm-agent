...
public class NumberComparator {
    ...
    public static int compareAsBigDecimals(Object actualNumber, Object comparisonNumber) {
        return new BigDecimal(actualNumber.toString()).compareTo(new BigDecimal(comparisonNumber.toString()));
    }

    public static boolean containsAsBigDecimals(Object actualNumber, Collection<?> comparisonNumbers) {

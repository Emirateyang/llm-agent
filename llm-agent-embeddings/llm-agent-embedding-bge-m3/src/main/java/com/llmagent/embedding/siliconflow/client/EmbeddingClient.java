...
public abstract class EmbeddingClient {
    ...
    public static Builder builder() {
        return DefaultEmbeddingClient.builder();
    }

    @SuppressWarnings("unchecked")
    public abstract static class Builder<T extends EmbeddingClient, B extends Builder<T, B>> {

        public String baseUrl = TEXT_MODAL_API_URL;

 ...
 */
public class OnnxEmbeddingModel extends ProcessEmbeddingModel {

    private final OnnxBertEncoder onnxBertEncoder;
    ...
    public OnnxEmbeddingModel(Path pathToModel, Path pathToTokenizer, PoolingMode poolingMode) {
        super(null);
        this.onnxBertEncoder = loadFromFileSystem(pathToModel, pathToTokenizer, poolingMode);
    }

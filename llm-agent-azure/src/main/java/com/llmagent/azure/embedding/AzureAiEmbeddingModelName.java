...
public enum AzureAiEmbeddingModelName {
    ...
    AzureAiEmbeddingModelName(String modelName, String modelType, Integer dimension) {
    ...
    AzureAiEmbeddingModelName(String modelName, String modelType, String modelVersion, Integer dimension) {
        this.modelName = modelName;
        this.modelType = modelType;
    ...
    private static final Map<String, Integer> KNOWN_DIMENSION = new HashMap<>(AzureAiEmbeddingModelName.values().length);

    static {
        for (AzureAiEmbeddingModelName embeddingModelName : AzureAiEmbeddingModelName.values()) {

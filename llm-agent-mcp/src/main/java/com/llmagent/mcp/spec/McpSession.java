 ...
 * This interface provides methods for sending requests and notifications, as well as managing the session lifecycle.
 *
 * <p>
 * The session operates asynchronously using Project Reactor's {@link Mono} type for non-blocking operations.
 * It supports both request-response patterns and one-way notifications.
 * </p>
 */
public interface McpSession extends AutoCloseable {
     ...
     *
     * <p>
     * This method handles the request-response pattern where a response is expected from the client or server.
     * The response type is determined by the provided TypeReference.
     * </p>
     ...
     *
     * <p>
     * This method implements the notification pattern where no response is expected from the counterparty.
     * It's useful for fire-and-forget scenarios.
     * </p>
